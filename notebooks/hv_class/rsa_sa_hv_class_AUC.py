...
y_hat_RSA_fp = st.normalized_pLDDT_30mer(all_statistics_hv_class_fp, "mean_rsa_slice")
y_true_RSA = all_statistics_hv_class_fp.select(pl.col("epitope"))
inverse_norm_rsa_mean_30mer_fp_hv_class = st.plot_auc_roc_curve(
    y_true_RSA, y_hat_RSA_fp, "hv_class Normalized mean RSA values for 30mer fp ROC"
)
...
y_hat_SA_fp = st.normalized_pLDDT_30mer(all_statistics_hv_class_fp, "mean_sa_slice")
y_true_SA = all_statistics_hv_class_fp.select(pl.col("epitope"))
inverse_norm_sa_mean_30mer_fp_hv_class = st.plot_auc_roc_curve(
    y_true_SA, y_hat_SA_fp, "hv_class Normalized mean SA values for 30mer fp ROC"
)
