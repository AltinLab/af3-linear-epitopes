...
process COMBINE_HV {
  ...
  memory '3 GB'
  clusterOptions '--nodes=1 --ntasks=1 --time=01:00:00'
  publishDir "$params.data_dir/peptide/staged", mode: 'copy'
  conda "envs/env.yaml"
...
workflow {
  ...
  hv1 = CLEAN_HV1(Channel.fromPath("$params.data_dir/raw/PV1_meta_2020-11-23.tsv"))
  hv2 = CLEAN_HV2(Channel.fromPath("$params.data_dir/raw/HV2_annot.csv"))
  COMBINE_HV(hv1, hv2)
  
  CLEAN_FOCAL_PROTEIN(Channel.fromPath("$params.data_dir/raw/fulldesign_2019-02-27_wGBKsw.fasta"))
